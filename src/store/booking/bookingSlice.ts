...
// import { BookingFieldPayload, BookingState, ParcelItemFieldPayload } from './types';
...
// export const { updateBookingField, updateParcelItemField, resetBooking } = bookingSlice.actions;
