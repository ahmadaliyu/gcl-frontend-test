  ...
  return (
    <div className="flex flex-col gap-[16px] w-full">
      ...
      <div className="my-4 relative flex gap-x-4 items-center">
        ...
        <div className="text-[#4e4e4e]    text-[12px] font-medium ">OR</div>
        <div className="h-px bg-[#E7E7E7]  flex-1" />
      </div>
      <div className="flex flex-1 self-stretch md:self-start w-full" id="signin-with-email">
        <button
          title="email"
          className="flex-1 inline-flex items-center justify-center gap-[15px]   text-[14px] md:text-[16px] leading-6 font-normal text-[#4e4e4e]  rounded-[10px] border-[1px] border-[#E6E8EC]  py-[8px] px-[15px]"
          type="button"
          id="emailLogin"
          onClick={formToggle}
        >
