...
function UserPaymentAndInvoices() {
  return (
    <UserDashboardWrapper>
      <h1 className="text-[#272727] font-[600] text-[24px] mb-[56px]">My Payments & Invoices</h1>
            ...
            <TableBody>
              {payments.map((payment) => (
                <TableRow key={payment.id}>
                  ...
                  <TableCell className="border-b border-b-[#E3E3E3] font-medium py-[30px] px-[8px]">
                    <div
                      className={`h-[41px] flex items-center justify-center rounded-[32px] px-[12px] w-[120px] ${payment.status === 'Pending'
